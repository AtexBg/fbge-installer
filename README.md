...
## Compiling : 
Just go to the project directory and run `make`. If you want to make an installable title in `.cia` format you can run the `cia/3dsx2cia.bat` script (**for Windows only**) and the compiled 3DSX binary will be converted to `build/FBGE-INSTALLER.CIA`.
